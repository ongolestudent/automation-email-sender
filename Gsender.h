...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "cmFtZXNoOTgua2FzdWxhQGdtYWlsLmNvbQ==";
        const char* EMAILBASE64_PASSWORD = "a2FzdWxhQDczMzcwMjI2NzM=";
        const char* FROM = "ramesh98.kasula@gmail.com";
